...
/**
 * Raccoglie QR, codice, sensori e teletrasporto per dichiarare la posizione. I
 * sensori partono solo su richiesta; codice e scelta manuale mantengono accessibile
 * la stessa funzione.
 */
